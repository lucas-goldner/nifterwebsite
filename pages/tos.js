...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>NFT Metro Website</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Nifter Website</h1>
        ...
        <p className={styles.description}>
          ...
          related to it, still belong to Nifter GbR. Nifter GbR is committed to
          ...
          exactly what you’re paying for. The Nifter app stores and processes
          ...
          that the Nifter app won’t work properly or at all. The app does use
          ...
          app Google Play Services Google Analytics for Firebase You should be
          aware that there are certain things that Nifter GbR will not take
          ...
          provided by your mobile network provider, but Nifter GbR cannot take
          ...
          from the bill payer for using the app. Along the same lines, Nifter
          GbR cannot always take responsibility for the way you use the app i.e.
          You need to make sure that your device stays charged – if it runs out
          of battery and you can’t turn it on to avail the Service, Nifter GbR
          cannot accept responsibility. With respect to Nifter GbR’s
          ...
          to you. Nifter GbR accepts no liability for any loss, direct or
          ...
          app. The app is currently available on Android & iOS – the
          ...
          to download the updates if you want to keep using the app. Nifter GbR
          ...
          Conditions We may update our Terms and Conditions from time to time.
          ...
          as of 2021-03-12 Contact Us If you have any questions or suggestions
